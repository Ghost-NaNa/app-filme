    ...
    return (
        <View style={styles.container}>
            ...
            renderItem={({ item }) => (
                ...
                <CardsFilmes titulo ={ item.nome} nota = {item.nota} imagem = {item.image} genero={item.genero} autor={item.autor} lancamento={item.dataLancamento} sinopse={item.sinopse}> </CardsFilmes>
            )}
        />
